...
class TestAdminLogoutTokenRevocation:
    ...
    def test_post_revokes_token_in_blocklist(self, disable_admin_csrf, main_app_with_admin_api):
    ...
    def test_post_without_jwt_cookie_does_not_call_blocklist(self, disable_admin_csrf, main_app_with_admin_api):
    ...
    def test_post_with_invalid_jwt_cookie_does_not_block_logout(self, disable_admin_csrf, main_app_with_admin_api):
        with (
            patch("mcpgateway.admin.verify_jwt_token_cached", new_callable=AsyncMock) as mock_verify,
            patch("mcpgateway.services.token_blocklist_service.get_token_blocklist_service") as mock_get_service,
        ):
    ...
    def test_post_payload_without_jti_does_not_revoke(self, disable_admin_csrf, main_app_with_admin_api):
    ...
    def test_post_blocklist_failure_does_not_block_logout(self, disable_admin_csrf, main_app_with_admin_api):
        token, payload = _build_admin_jwt()
