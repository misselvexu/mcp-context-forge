    ...
    async def _export_servers(
        ...
        for server in servers:
            server_data = {
                ...
                "websocket_endpoint": f"{root_path}/v1/servers/{server.id}/ws",
                "jsonrpc_endpoint": f"{root_path}/v1/servers/{server.id}/jsonrpc",
    ...
    async def _export_selected_servers(
        ...
        for db_server in db_servers:
            ...
            server_data = {
                ...
                "tool_ids": tool_ids,
                "sse_endpoint": f"{root_path}/v1/servers/{db_server.id}/sse",
                "websocket_endpoint": f"{root_path}/v1/servers/{db_server.id}/ws",
                "jsonrpc_endpoint": f"{root_path}/v1/servers/{db_server.id}/jsonrpc",
                "capabilities": {"tools": {"list_changed": True}, "prompts": {"list_changed": True}},
