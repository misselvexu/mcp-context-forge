...
export const SEARCH_CONFIGS = {
  toolsAdd: {
    ...
    apiEndpoint: "/v1/admin/tools/search",
    partialEndpoint: "/v1/admin/tools/partial",
    dataKey: "tools",
  ...
  promptsAdd: {
    ...
    apiEndpoint: "/v1/admin/prompts/search",
    partialEndpoint: "/v1/admin/prompts/partial",
    dataKey: "prompts",
  ...
  resourcesAdd: {
    ...
    apiEndpoint: "/v1/admin/resources/search",
    partialEndpoint: "/v1/admin/resources/partial",
    dataKey: "resources",
